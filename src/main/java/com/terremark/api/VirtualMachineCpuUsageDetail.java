...
/**
 * <p>Java class for VirtualMachineCpuUsageDetail complex type.
 * 
...
@XmlType(name = "VirtualMachineCpuUsageDetail", propOrder = {
    "usage",
    "utilization",
    "deleted"
})
public class VirtualMachineCpuUsageDetail
    extends Reference
{
